...
final class Notices {
	 ...
	 * @var string
	 */
	const DISMISS_META = 'hogpress_setup_notice_dismissed';
	 ...
	 * @var string
	 */
	const DISMISS_ARG = 'hogpress_dismiss_setup';
		...
		<div class="notice notice-info">
			...
			<p>
				<a class="button button-primary" href="<?php echo esc_url( $setup_url ); ?>">
					<?php esc_html_e( 'Set up PostHog', 'hogpress' ); ?>
				</a>
				<a class="button-link" href="<?php echo esc_url( $dismiss_url ); ?>">
					<?php esc_html_e( 'Dismiss', 'hogpress' ); ?>
				</a>
			</p>
		</div>
		<?php
