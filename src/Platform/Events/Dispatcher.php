...
namespace Hogpress\Platform\Events;

use Hogpress\Core\Events\Schema;
use Hogpress\Core\Events\ServerClient;
...
final class Dispatcher {
	...
	private function log( $message ) {
		if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
			error_log( 'hogpress: ' . $message ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
		}
	}
}
